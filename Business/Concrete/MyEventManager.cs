...
namespace Business.Concrete
{
    public class MyEventManager : IMyEventService
    {
        ...
        public IDataResult<List<MyEvent>> GetActives(int userId)
        {
            ...
            return new SuccessDataResult<List<MyEvent>>(_myEventDal.GetAll(e => e.UserId != userId && e.Date > DateTime.Now && !attendedEvents.Contains(e.Id) && e.ParticipantCount != e.ParticipantLimit), Messages.EventsListed);
        }
